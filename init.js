...
News.insertMany( [
  {
    title: 'Breaking News: Local School Wins Championship!',
  ...
  {
    title: 'Technology Advances: New AI Innovations',
  ...
  {
    title: 'Weather Alert: Heavy Rainfall Expected This Weekend',
  ...
  {
    title: 'Sports Update: City Football Team Scores a Stunning Win',
  ...
  {
    title: 'Health News: New Guidelines for Nutrition in 2025',
  ...
  // New Dummy Data
  {
    title: 'Politics: New Election Law Changes in 2025',
  ...
  {
    title: 'Economy: Global Stocks Surge to Record Highs',
  ...
  {
    title: 'Health: Mental Health Awareness Month Kicks Off',
  ...
  {
    title: 'Entertainment: Major Movie Release Coming This Friday',
  ...
  {
    title: 'Technology: SpaceX Successfully Launches Mars Probe',
  ...
  {
    title: 'Science: New Fossils Discovered in the Amazon',
  ...
  {
    title: 'Sports: Tennis Star Wins Grand Slam Tournament',
  ...
  {
    title: 'Business: Tech Giant Acquires Startup for $5 Billion',
  ...
  {
    title: 'Travel: New Airline Routes Open Between Asia and Europe',
  ...
  {
    title: 'Culture: Annual Art Festival Kicks Off in Paris',
  ...
  {
    title: 'Food: New Vegan Restaurant Opens Downtown',
  ...
  {
    title: 'Weather: Record Heatwave in the Southern States',
  ...
  {
    title: 'Automotive: Electric Cars Now Account for 20% of Sales',
  ...
  {
    title: 'Music: New Album by Indie Band Hits Number One',
